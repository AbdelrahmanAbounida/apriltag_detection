...
import { UseInputParameters, UseInputRootSlotProps } from '@mui/base/InputUnstyled/useInput.types';
...
export declare type InputUnstyledOwnerState = Simplify<Omit<InputUnstyledProps, 'component' | 'slots' | 'slotProps'> & {
