...
import { UseSelectOptionSlotProps } from '@mui/base/SelectUnstyled/useSelect.types';
...
export interface OptionUnstyledOwnProps<TValue> {
     ...
     */
    slotProps?: {
        root?: SlotComponentProps<'li', OptionUnstyledComponentsPropsOverrides, OptionUnstyledOwnerState<TValue>>;
    };
    /**
...
export declare type OptionUnstyledProps<TValue, D extends React.ElementType = OptionUnstyledTypeMap<TValue>['defaultComponent']> = OverrideProps<OptionUnstyledTypeMap<TValue, {}, D>, D> & {
    component?: D;
};
...
export declare type OptionUnstyledOwnerState<TValue> = Simplify<OptionUnstyledOwnProps<TValue> & OptionState>;
export declare type OptionUnstyledRootSlotProps<TValue> = Simplify<UseSelectOptionSlotProps & {
    children?: React.ReactNode;
    className: string;
