...
export interface ModalUnstyledOwnProps {
     ...
     */
    slotProps?: {
        root?: SlotComponentProps<'div', ModalUnstyledComponentsPropsOverrides, ModalUnstyledOwnerState>;
        backdrop?: SlotComponentProps<'div', ModalUnstyledComponentsPropsOverrides, ModalUnstyledOwnerState>;
    };
    /**
...
export declare type ExtendModalUnstyled<M extends OverridableTypeMap> = OverridableComponent<ExtendModalUnstyledTypeMap<M>>;
export declare type ModalUnstyledProps<D extends React.ElementType = ModalUnstyledTypeMap['defaultComponent']> = OverrideProps<ModalUnstyledTypeMap<{}, D>, D> & {
    component?: D;
};
export declare type ModalUnstyledOwnerState = ModalUnstyledProps & {
    closeAfterTransition: boolean;
    disableAutoFocus: boolean;
    disableEnforceFocus: boolean;
    disableEscapeKeyDown: boolean;
...
export declare type ModalUnstyledRootSlotProps = {
...
export declare type ModalUnstyledBackdropSlotProps = {
