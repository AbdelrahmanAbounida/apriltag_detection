...
declare type TabsUnstyledOrientation = 'horizontal' | 'vertical';
declare type TabsUnstyledDirection = 'ltr' | 'rtl';
...
export declare type TabsUnstyledProps<D extends React.ElementType = TabsUnstyledTypeMap['defaultComponent'], P = {}> = OverrideProps<TabsUnstyledTypeMap<P, D>, D> & {
    component?: D;
};
export declare type TabsUnstyledOwnerState = TabsUnstyledProps & {
    orientation: TabsUnstyledOrientation;
    direction: TabsUnstyledDirection;
};
export declare type TabsUnstyledRootSlotProps = {
