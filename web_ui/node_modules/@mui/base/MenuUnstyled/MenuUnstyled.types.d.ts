...
import { UseMenuListboxSlotProps } from '@mui/base/MenuUnstyled/useMenu.types';
...
export interface MenuUnstyledOwnProps {
     ...
     */
    slotProps?: {
        root?: SlotComponentProps<typeof PopperUnstyled, MenuUnstyledComponentsPropsOverrides, MenuUnstyledOwnerState>;
        listbox?: SlotComponentProps<'ul', MenuUnstyledComponentsPropsOverrides, MenuUnstyledOwnerState>;
    };
    /**
...
export declare type MenuUnstyledProps<D extends React.ElementType = MenuUnstyledTypeMap['defaultComponent']> = OverrideProps<MenuUnstyledTypeMap<{}, D>, D> & {
    component?: D;
};
export interface MenuUnstyledOwnerState extends MenuUnstyledOwnProps {
    open: boolean;
}
export declare type MenuUnstyledRootSlotProps = {
    anchorEl: PopperUnstyledProps['anchorEl'];
    children?: React.ReactNode;
    className?: string;
...
export declare type MenuUnstyledListboxSlotProps = UseMenuListboxSlotProps & {
